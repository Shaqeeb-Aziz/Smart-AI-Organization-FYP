...
wb = load_workbook("D:\\smart ai files\\entrance\\Excel sheets per day\\"+day+"-"+month+"-"+year+".xlsx")





entrance = "D:\\smart ai files\\entrance\\"+day+"-"+month+"-"+year
            ...
            if matches[matchindex]:
                ...
                for i in range(1, 1048576, 1):
                    ...
                    if item == name:
                        ...
                        sh[f"D{i}"] = c_time
                        break
                wb.save("D:\\smart ai files\\entrance\\Excel sheets per day\\"+day+"-"+month+"-"+year+".xlsx")
